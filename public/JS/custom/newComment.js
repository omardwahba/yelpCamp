...
star1.on('click mouseover' , function(e){
    clearStars();
    $(this).addClass('checked');
    slecet.val($('select option:nth-child(1)').val());
});

star2.on('click mouseover' , function(e){
    clearStars();
...
star3.on('click mouseover' , function(e){
    clearStars();
    star1.addClass('checked');
...
star4.on('click mouseover' , function(e){
    clearStars();
    star1.addClass('checked');
    star2.addClass('checked');
...
star5.on('click mouseover' , function(e){
    clearStars();
    star1.addClass('checked');
    star2.addClass('checked');
    star3.addClass('checked');
